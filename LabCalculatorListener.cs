...
public interface ILabCalculatorListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterMaxExp([NotNull] LabCalculatorParser.MaxExpContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>MaxExp</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitMaxExp([NotNull] LabCalculatorParser.MaxExpContext context);
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterMinExp([NotNull] LabCalculatorParser.MinExpContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>MinExp</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitMinExp([NotNull] LabCalculatorParser.MinExpContext context);
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterModExp([NotNull] LabCalculatorParser.ModExpContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>ModExp</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitModExp([NotNull] LabCalculatorParser.ModExpContext context);
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterDivExp([NotNull] LabCalculatorParser.DivExpContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>DivExp</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitDivExp([NotNull] LabCalculatorParser.DivExpContext context);
